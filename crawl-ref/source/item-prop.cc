...
static const weapon_def Weapon_prop[] =
{
    ...
    { WPN_CLUB,              "club",                5,  3, 13,
        ...
        DAMV_CRUSHING, 100, 0, 5, CLUB_BRANDS },
#if TAG_MAJOR_VERSION == 34
    ...
    { WPN_HAMMER,            "hammer",              7,  3, 13,
        SK_MACES_FLAILS, SIZE_LITTLE, SIZE_LITTLE, MI_NONE,
        DAMV_CRUSHING, 1, 0, 0, M_AND_F_BRANDS },
#endif
    { WPN_MACE,              "mace",                8,  3, 14,
        SK_MACES_FLAILS, SIZE_LITTLE, SIZE_LITTLE, MI_NONE,
        DAMV_CRUSHING, 90, 0, 30, M_AND_F_BRANDS },
    { WPN_FLAIL,             "flail",              10,  0, 14,
        SK_MACES_FLAILS, SIZE_LITTLE, SIZE_LITTLE, MI_NONE,
        DAMV_CRUSHING, 80, 10, 35, M_AND_F_BRANDS },
    { WPN_MORNINGSTAR,       "morningstar",        13, -2, 15,
        SK_MACES_FLAILS, SIZE_LITTLE, SIZE_LITTLE, MI_NONE,
        DAMV_CRUSHING | DAM_PIERCE, 70, 20, 60, {
            { SPWPN_PROTECTION,     30 },
            { SPWPN_NORMAL,         15 },
            { SPWPN_HOLY_WRATH,     15 },
            { SPWPN_DRAINING,       10 },
    ...
    { WPN_SHORT_SWORD,       "short sword",         5,  4, 10,
        SK_SHORT_BLADES, SIZE_LITTLE, SIZE_LITTLE, MI_NONE,
        DAMV_PIERCING, 80, 0, 30, SBL_BRANDS },
    { WPN_RAPIER,           "rapier",               7,  4, 12,
        SK_SHORT_BLADES, SIZE_LITTLE, SIZE_LITTLE, MI_NONE,
        DAMV_PIERCING, 80, 25, 55, SBL_BRANDS },
#if TAG_MAJOR_VERSION == 34
    { WPN_CUTLASS,          "cutlass",              8,  4, 12,
        SK_SHORT_BLADES, SIZE_LITTLE, SIZE_LITTLE, MI_NONE,
        DAMV_SLICING | DAM_PIERCE, 1, 0, 0, {}},
#endif
...
#if TAG_MAJOR_VERSION == 34
    { OBJ_WEAPONS,   WPN_BLESSED_FALCHION },
    { OBJ_WEAPONS,   WPN_BLESSED_LONG_SWORD },
    { OBJ_WEAPONS,   WPN_BLESSED_SCIMITAR },
    { OBJ_WEAPONS,   WPN_BLESSED_DOUBLE_SWORD },
    { OBJ_WEAPONS,   WPN_BLESSED_GREAT_SWORD },
    { OBJ_WEAPONS,   WPN_BLESSED_TRIPLE_SWORD },
#endif
...
// placement, especially those with a rarity of zero. Chance is out of 100.
